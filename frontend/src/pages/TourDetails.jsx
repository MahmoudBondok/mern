                     ...
                     <div className="tour__content">
                        ...
                        <div className="tour__info">
                           ...
                           <div className="tour__extra-details">
                              ...
                              <span><i class='ri-money-dollar-circle-line'></i> {price}/ للشخص الواحد</span>
                              <span><i class='ri-map-pin-time-line'></i> {distance} k/m</span>
                              <span><i class='ri-group-line'></i> {maxGroupSize} العدد</span>
                           </div>
                           <h5>الوصف</h5>
                           <p>{desc}</p>
                        </div>
                        ...
                        <div className="tour__reviews mt-4">
                           <h4>التقييمات ({reviews?.length} تقييم)</h4>
